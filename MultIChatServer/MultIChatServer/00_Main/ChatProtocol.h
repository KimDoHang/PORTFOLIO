...
const int32 CS_CHAT_REQ_LOGIN_PACKET_SIZE = sizeof(WCHAR) * 40 + sizeof(CHAR) * 64 + sizeof(INT64);
const int32 CS_CHAT_RES_LOGIN_PACKET_SIZE = sizeof(BYTE) + sizeof(INT64);
const int32 CS_CHAT_REQ_SECTOR_MOVE_PACKET_SIZE = sizeof(INT64) + sizeof(WORD) + sizeof(WORD);
const int32 CS_CHAT_RES_SECTOR_MOVE_PACKET_SIZE = sizeof(INT64) + sizeof(WORD) + sizeof(WORD);
const int32 CS_CHAT_REQ_MESSAGE_PACKET_SIZE = sizeof(INT64) + sizeof(WORD) + sizeof(WORD);
const int32 CS_CHAT_RES_MESSAGE_PACKET_SIZE = sizeof(INT64) + sizeof(WORD) + sizeof(WORD);
const int32 CS_CHAT_REQ_HEARTBEAT_PACKET_SIZE = sizeof(WORD);
...
enum PACKET_TYPE : uint16
{
	...
	en_PACKET_CREATE_SESSION,
	en_PACKET_RELEASE_SESSION,
	...
	//
	//------------------------------------------------------------
	en_PACKET_MS_CHAT_REQ_LOGIN = 10,
	...
	//
	//------------------------------------------------------------
	en_PACKET_MS_CHAT_RES_LOGIN = 11,
	...
	//
	//------------------------------------------------------------
	en_PACKET_MS_CHAT_RES_MONITOR_INFO,
	...
	//	{
	//		WORD	Type
	//		BYTE	Status		// 같은 종류에 대한 서버 번호
	//	}
	//
	//------------------------------------------------------------
	en_PACKET_SS_MONITOR_LOGIN_RES,
	...
	//
	//------------------------------------------------------------
	en_PACKET_SS_MONITOR_SECTOR_INFO,
...
enum en_PACKET_SS_MONITOR_DATA_UPDATE
{
	...
	dfMONITOR_DATA_TYPE_MONITOR_NETWORK_RETRANSMISSION = 45,		// 서버컴퓨터 사용가능 메모리

	dfMAX_MONITOR_DATA_NUM,
};
...
enum en_PACKET_CS_MONITOR_TOOL_RES_LOGIN
{
	...
	dfMONITOR_TOOL_LOGIN_MAX_PLAYER = 4,
};
