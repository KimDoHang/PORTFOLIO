...
const int32 eLAN_RECV_BUFFER_DEFAULT = 10000;
const int32 eNET_RECV_BUFFER_DEFAULT = 10000;

//SendPacket의 직렬화 버퍼 크기
const int32 eLAN_SEND_BUFFER_DEFAULT = 6000;
const int32 eNET_SEND_BUFFER_DEFAULT = 6000;
