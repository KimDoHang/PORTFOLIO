...
//RecvPacket 배열 크기
const int32 eLAN_SERIALIZE_BUFFER_ARR_SIZE = 200;
const int32 eNET_SERIALIZE_BUFFER_ARR_SIZE = 200;

//RecvPacket의 직렬화 버퍼 크기
const int32 eLAN_RECV_BUFFER_DEFAULT = 4000;
const int32 eNET_RECV_BUFFER_DEFAULT = 4000;

//SendPacket의 직렬화 버퍼 크기
const int32 eLAN_SEND_BUFFER_DEFAULT = 700;
const int32 eNET_SEND_BUFFER_DEFAULT = 700;
