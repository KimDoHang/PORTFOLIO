...
{
	en_PACKET_CS_CHATREQ_LOGIN = 1,
	en_PACKET_SC_CHATRES_LOGIN = 2,
	en_PACKET_CS_CHATREQ_SECTORMOVE = 3,
	en_PACKET_SC_CHATRES_SECTORMOVE = 4,
	en_PACKET_CS_CHATREQ_MESSAGE = 5,
	en_PACKET_SC_CHATRES_MESSAGE = 6,
	en_PACKET_CS_CHATREQ_HEARTBEAT = 7,
