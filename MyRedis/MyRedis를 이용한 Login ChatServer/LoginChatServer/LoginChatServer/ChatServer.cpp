...
ChatServer::ChatServer() :_player_num(0), _monitor_client(nullptr), _chat_group(nullptr)
{
...
void ChatServer::ChatInit(const WCHAR* text_file)
{
	...
	g_redis = new RedisUtils(L"127.0.0.1", 17000);
...
bool ChatServer::EnqueueChatGroupGob(ChatGroupJob chat_job)
{
